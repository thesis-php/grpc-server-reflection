...
final readonly class ServerReflectionClient
{
     ...
     *
     * @return Client\BidirectionalStreamChannel<\Grpc\Reflection\V1alpha\ServerReflectionRequest, \Grpc\Reflection\V1alpha\ServerReflectionResponse>
     */
    public function serverReflectionInfo(
        Metadata $md = new Metadata(),
        Cancellation $cancellation = new NullCancellation(),
    ): Client\BidirectionalStreamChannel {
        /** @var Client\Invoke<\Grpc\Reflection\V1alpha\ServerReflectionRequest, \Grpc\Reflection\V1alpha\ServerReflectionResponse> $invoke */
        $invoke = new Client\Invoke(
            method: '/grpc.reflection.v1alpha.ServerReflection/ServerReflectionInfo',
            output: \Grpc\Reflection\V1alpha\ServerReflectionResponse::class,
